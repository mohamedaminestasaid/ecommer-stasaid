...
const StripeSuccess = lazy(() => import("./pages/other/stripe-success"));
const ReturnPolicy = lazy(() => import("./pages/other/return"));
const StripeFail = lazy(() => import("./pages/other/stripe-fail"));

const NotFound = lazy(() => import("./pages/other/NotFound"));

const App = () => {
  if (
    localStorage.getItem("limo") === "ya" &&
    !["/payment-success", "/payment-fail", "/checkout"].includes(
  ...
  return (
    <Router>
      <ScrollToTop>
        <Suspense
          fallback={
            <div className="Stickerify-preloader-wrapper">
              <div className="Stickerify-preloader">
                <span></span>
                <span></span>
              </div>
            </div>
